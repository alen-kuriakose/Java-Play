...
class Routes(
  ...
  def documentation = List(
    ("""POST""", this.prefix, """controllers.HomeController.index(request:Request)"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """getmessage""", """controllers.HomeController.getmessage"""),
  ...
  // @LINE:6
  private[this] lazy val controllers_HomeController_index0_route = Route("POST",
  ...
  // @LINE:7
  private[this] lazy val controllers_HomeController_getmessage1_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("getmessage")))
  )
  private[this] lazy val controllers_HomeController_getmessage1_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_HomeController_getmessage1_route(params@_) =>
      call { 
        controllers_HomeController_getmessage1_invoker.call(HomeController_0.getmessage)
      }
